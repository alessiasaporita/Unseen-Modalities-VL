...
class MMIMDBDataset(BaseDataset):
    def __init__(self, *args, split="", preprocess=None, missing_info={}, **kwargs):
        ...
        if os.path.exists(missing_table_path):
            ...
            missing_table = torch.zeros(total_num) #15552
            ...
            if missing_ratio > 0:
                ...
                if missing_type == 'text':
                    ...
                    missing_table[missing_index_image] = 2 #text indices
        ...
        if self.split=='train':
            ...
            if self.missing_table[image_index] == 1:
                ...
                if os.path.exists(text_pseudo_path):
                    ...
                    print("Errore, pseudo-label non trovata: {}".format(text_pseudo_path))
                    text_pseudo = torch.zeros((23,))
        else:
            text_mask = np.ones((512, 1))
            text_pseudo = torch.zeros((23,))
